...
class Contact_Form {
	...
	private function define_public_hooks() {
		...
		$this->loader->add_action( 'get_footer', $plugin_public, 'footer_form_display' );
		$this->loader->add_action( 'init', $plugin_public, 'init_virtual_page' );
		$this->loader->add_action( 'wp_ajax_submit_contact_form', $plugin_public, 'submit_contact_form' );
		$this->loader->add_action( 'wp_ajax_nopriv_submit_contact_form', $plugin_public, 'submit_contact_form' );
